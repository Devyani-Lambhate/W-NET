...
class WNet(nn.Module):
    ...
    def forward(self,image_sst,image_ssh):
        ...
        ####################SST#########################
        #input1 =torch.cat((image_sst,image_ssh),1)
        #print(input1.shape)
        ...
        return h_sst_conv ,h_sst_conv,h_sst_conv,h_sst,h_sst,sst_encoder_1,sst_encoder_2,sst_encoder_3,sst_encoder_4,sst_encoder_5,sst_encoder_6,sst_decoder_1,sst_decoder_2,sst_decoder_3,sst_decoder_4,sst_decoder_5,sst_encoder_1,sst_encoder_2,sst_encoder_3,sst_encoder_4,sst_encoder_5,sst_encoder_6,sst_decoder_1,sst_decoder_2,sst_decoder_3,sst_decoder_4,sst_decoder_5
