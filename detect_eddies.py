...
1. All the eddies
2. Number of correctly detetcted eddies
3. All the eddies with diameter greather than 75 km
4. Number of correctly detected eddies with diameter greather than 75 km
5. percentage of eddies correctly detected
6. Average centroid difference
...
def count_eddies(l,e):
	...
	"""
        ...
        l : str
       	...
       	e : str
            Binary value either 'Warm' for warm eddies or 'Cold for cold eddies
	...
	#All the eddies are saved in a different color code 
